...
<jsp:include page="template-top.jsp" />
		...
		<div class="col-md-8 column" id="main">
			...
			<form method="post" action="register.do" class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input class="form-control" id="inputEmail3" type="text" name="firstName" value="${form.firstName }">
					</div>
				</div>
				<div class="form-group">
					 <label for="inputEmail3" class="col-sm-2 control-label">Last Name</label>
					<div class="col-sm-10">
						<input class="form-control" id="inputEmail3" type="text" name="lastName" value="${form.lastName }">
					</div>
				</div>
				<div class="form-group">
